...
public class HibernateUtil {
    ...
    static {
        registry = new StandardServiceRegistryBuilder()// получение реестра сервисов (что такое Service - http://docs.jboss.org/hibernate/orm/5.1/integrationsGuide/html_single/)
